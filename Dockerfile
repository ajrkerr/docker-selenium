...
RUN apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys 2EA8F35793D8809A \
  && apt-key update -qqy
...
RUN apt-key adv --keyserver hkp://keyserver.ubuntu.com:80 --recv-keys A2F683C52980AECF \
  && apt-key update -qqy
